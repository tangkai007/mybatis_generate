...
<script src="${contextPath}/assets/js/jquery-1.10.2.min.js?version=8c8592dc4a003b37aff623f4291accb4"></script>

<!-- <![endif]-->

<!--[if IE]>
<script src="${contextPath}/assets/js/jquery-2.0.3.min.js?version=8c8592dc4a003b37aff623f4291accb4"></script>
<![endif]-->
...
<script src="${contextPath}/assets/js/jquery-ui-1.10.3.custom.min.js?version=8c8592dc4a003b37aff623f4291accb4"></script>

<!-- ace scripts -->
<script src="${contextPath}/assets/js/ace-elements.min.js?version=8c8592dc4a003b37aff623f4291accb4"></script>
<script src="${contextPath}/assets/js/ace.min.js?version=8c8592dc4a003b37aff623f4291accb4"></script>
